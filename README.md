...
| 2 | `tier0:Naive` | 1.933 | 1.363 | 48.07 | 54.43 | 0.00793 |
| 3 | `tier2:lgb` | 1.934 | 1.383 | 52.09 | 58.29 | 0.007918 |
| 4 | `tier0:SeasonalNaive` | 2.482 | 1.819 | 61.41 | 68.82 | 0.01021 |
| 5 | `tier0:WindowAverage` | 3.117 | 2.258 | 88.65 | 93.5 | 0.01291 |
| 6 | `tier0:HistoricAverage` | 86.628 | 86.932 | 2241 | 2242 | 0.5354 |
...
| 2 | `tier0:RWD` | 3.416 | 2.747 | 93.74 | 108.6 | 0.01403 |
| 3 | `tier0:Naive` | 3.464 | 2.750 | 94.53 | 109.5 | 0.01427 |
| 4 | `tier0:SeasonalNaive` | 3.831 | 2.947 | 100.5 | 117.1 | 0.01575 |
| 5 | `tier0:WindowAverage` | 4.107 | 3.125 | 117.9 | 131.3 | 0.01706 |
| 6 | `tier0:HistoricAverage` | 87.391 | 88.489 | 2260 | 2261 | 0.5376 |

**Horizon 60 trading days** — ranked by MASE (lower is better)

| Rank | Model | MASE | MASE (median) | MAE | RMSE | sMAPE |
|---:|:--|--:|--:|--:|--:|--:|
| 1 | `tier0:RWD` | 5.579 | 4.314 | 162.3 | 189.8 | 0.02293 |
| 2 | `tier2:lgb` | 5.582 | 4.568 | 166.2 | 193.6 | 0.02284 |
| 3 | `tier0:Naive` | 5.713 | 4.411 | 165 | 192.8 | 0.02355 |
| 4 | `tier0:SeasonalNaive` | 6.010 | 4.873 | 169.3 | 198.5 | 0.02471 |
| 5 | `tier0:WindowAverage` | 6.097 | 4.927 | 179.3 | 206.6 | 0.0251 |
| 6 | `tier0:HistoricAverage` | 88.531 | 87.603 | 2287 | 2290 | 0.5405 |
